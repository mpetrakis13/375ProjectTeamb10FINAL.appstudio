...
const cacheName = '_75ProjectTeamb10TESTMAP-2021-12-06 20:11:30.869713'; // unique value, generated each deploy
const contentToCache = [
  'index.html',
  'code.js',
  'images/yellow_squiggle_rbtmcrnr.png',
  'images/green_sqgl_toprightcrnr.png',
  'images/keto_recipe_picture.png',
  'images/orange_sqgl_topyellocrnr.png',
  'images/yellow_sqgl_btmleftcrnr.png',
  'images/logo.png',
  ...
  'toolbox/as/dist/asFunctions.js',
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, '_75ProjectTeamb10TESTMAP'.length) === '_75ProjectTeamb10TESTMAP') {
